        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <Link href="/" className="flex justify-center items-center text-rose-600 bg-gray-800 hover:text-gray-100 hover:bg-rose-600 rounded-full transition duration-150 ease-in-out" aria-label="Twitter">
              ...
              <li className="ml-4">
                <Link href="/" className="flex justify-center items-center text-rose-600 bg-gray-800 hover:text-gray-100 hover:bg-rose-600 rounded-full transition duration-150 ease-in-out" aria-label="Github">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="ml-4">
                <Link href="/" className="flex justify-center items-center text-rose-600 bg-gray-800 hover:text-gray-100 hover:bg-rose-600 rounded-full transition duration-150 ease-in-out" aria-label="Facebook">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="ml-4">
                <Link href="/" className="flex justify-center items-center text-rose-600 bg-gray-800 hover:text-gray-100 hover:bg-rose-600 rounded-full transition duration-150 ease-in-out" aria-label="Instagram">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="ml-4">
                <Link href="/" className="flex justify-center items-center text-rose-600 bg-gray-800 hover:text-gray-100 hover:bg-rose-600 rounded-full transition duration-150 ease-in-out" aria-label="Linkedin">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
