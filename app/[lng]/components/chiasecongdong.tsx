...
const testimonials = [
  {
    ...
    quote: "Cảm ơn toàn thể các thầy cô và CBNV đã tạo nên sự khác biệt rất lớn mà theo tôi rất đậm phong cách EMASI “Ngôi trường của thế hệ tiên phong”. Khi tôi hỏi con tôi “con thích nhất điều gì khi đi học tại trường” thì một bé 6 tuổi cũng có thể nói ra cảm nhận của mình “niềm vui khi mỗi ngày đến lớp”.",
    author: "- Nguyễn văn B -",
    position: "UX Board"
  }, {
    image: TestimonialImage01,
    people: "Chia sẻ của giáo viên",
    quote: "Tại EMASI, học sinh không những học lý thuyết mà còn được ứng dụng lý thuyết vào trong thực hành. Không chỉ có vậy, học sinh còn được trải nghiệm và sáng tạo, đồng thời phát triển các kỹ năng mềm như làm việc nhóm.",
              ...
              <div key={index} className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
                <div className='flex gap-x-4 items-center '>
                  <div className="relative inline-flex flex-col mb-4">
                    <Image className="rounded-full" src={testimonial.image} width={80} height={80} alt={`Testimonial ${index + 1}`} />
                    <svg className="absolute top-0 left-0 -mr-3 w-6 h-5 fill-current text-rose-600" viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <blockquote className="text-lg text-gray-400 grow">— {testimonial.quote}</blockquote>
                <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                  <cite className="text-gray-400 not-italic">{testimonial.author}</cite> -
