      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        <div className='grid grid-cols-2 gap-x-10'>
          <div>
            ...
            <div className='h3 mt-6 mb-5' data-aos="fade-up" data-aos-delay="200">Các cấp học toàn diện tại <br /> Giáo Dục Phượng Hoàng</div>
            <p className='p mb-5' data-aos="fade-up" data-aos-delay="400">Tại Giáo Dục Phượng Hoàng, học sinh sẽ được hòa mình và trải nghiệm một môi trường giáo dục được thiết kế riêng biệt và độc đáo với mục tiêu dẫn lối thành công, giúp trang bị những kỹ năng và tri thức cho học sinh tiến xa trên con đường trở thành những công dân toàn cầu tương lai.</p>
            <p className='p mb-5' data-aos="fade-up" data-aos-delay="400">Giáo Dục Phượng Hoàng hân hạnh mang trong mình sứ mệnh tiên phong, đem đến cho học sinh một chương trình học tập toàn diện với 3 cấp học bao gồm:</p>
