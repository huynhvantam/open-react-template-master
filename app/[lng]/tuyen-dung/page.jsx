      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 ">
        <div>
          ...
          <p className="p">
            ...
            lương thưởng cạnh tranh, EMASI mang đến cho nhân viên cơ hội phát
            triển bản thân, thăng tiến trong sự nghiệp và trải nghiệm một môi
            trường làm việc đa văn hóa và không ngừng tiến bộ.
          </p>
        </div>
        <div>
