    ...
    <>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="p space-y-4">
          ...
          <p>
            Chương trình đào tạo bậc Trung học tại ROYAL SCHOOL không chỉ trang
            bị cho học sinh nền tảng tri thức và ngôn ngữ vững chắc mà còn tạo
            điều kiện để các em phát triển năng lực tự học, tự do sáng tạo, hình
            thành phẩm chất của công dân toàn cầu, đồng thời phát hiện, bồi
          ...
          <p>
            ...
            học sinh, ROYAL SCHOOL triển khai lộ trình học tập cấp Trung học với
            02 hệ chương trình đào tạo song song: Chương trình Trung học Song
            ngữ Quốc tế và Chương trình Trung học Hội nhập Quốc tế, giúp người
            học dễ dàng lựa chọn hướng tiếp cận kiến thức phù hợp và chinh phục
            thành công trong môi trường học tập quốc tế năng động.
          </p>
        </div>
        {/* 2nd */}
